                        ...
                        if (track === trackDB) {
                            ...
                            onValue(ref(db, `parcels/${hrefDB}/options`), (snapshot) => {
                                ...
                                if(statusDB.option5 === undefined){
                                    ...
                                    //     <div class="status_el">
                                    //     <div class="status-ellipse">
                                    //         <div class="ellips" style="background-color: ${statusDB.optionR1 != undefined ? '#8faf82':'' || statusDB.optionR2 != undefined ? '#8faf82':''};"></div>
                                    //     </div>
                                    //     <div><p>Поступило на <br/> склад в ${statusDB.optionR1 != undefined ? 'Усть - Каменогорск':'' || statusDB.optionR2 != undefined ? 'Астана':''}</p><p class="date">${statusDB.optionR1 != undefined ? statusDB.optionR1 : '' || statusDB.optionR2 != undefined ? statusDB.optionR2 : ''}</p></div>
                                    // </div>
